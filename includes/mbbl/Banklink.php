...
class Banklink
{
    ...
    public function __construct($protocol, $country = 'LT', $bank = 'SEB', $requestUrl = '')
    {
        ...
        if (!empty($requestUrl)) {
            ...
            if ($country == 'ET') {
                if ($bank == 'CITADELE') {
                    ...
                    $this->requestUrl = 'https://banklink.swedbank.com/EE/NDEAEE2X';
                } else {
                ...
                if ($bank == 'CITADELE') {
                    ...
                    $this->requestUrl = 'https://banklink.swedbank.com/LT/AGBLLT2X';
                } else if ($bank == 'SIAULIU') {
                    $this->requestUrl = 'https://banklink.swedbank.com/LT/CBSBLT26';
                } else if ($bank == 'MEDICINOS') {
                    $this->requestUrl = 'https://banklink.swedbank.com/LT/MDBALT22';
                } else {
                    throw new UnexpectedValueException('Please select supported bank');
                }
            } else {
